 ...
 */
package io.cubita.trial.spring.config;
...
public abstract class AbstractConfiguredSecurityBuilder<O, B extends SecurityBuilder<O>>
	...
	private enum BuildState {
		/**
		 * This is the state before the {@link1 Builder#build()} is invoked
		 */
		UNBUILT(0),

		/**
		 * The state from when {@link1 Builder#build()} is first invoked until all the

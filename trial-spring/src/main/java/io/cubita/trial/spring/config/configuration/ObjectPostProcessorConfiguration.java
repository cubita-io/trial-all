 ...
 */
package io.cubita.trial.spring.config.configuration;
 ...
 * using {@link2 EnableWebSecurity} or {@link2 EnableGlobalMethodSecurity}.
 *
 * @see2 EnableWebSecurity
 * @see2 EnableGlobalMethodSecurity
 *
 * @author Rob Winch
 * @since 3.2
 */
